    ...
    def train(self, model_components):
        ...
        for i in range(starting_step, starting_step + nb_steps):
            ...
            if not i % log_interval:  # 2x faster than testing each step...
                ...
                list_loss_real_bot.append(
                    d_loss_real_B[0])
                list_loss_real_normal.append(
                    d_loss_real_N[0])
                list_loss_fake_bot.append(
                    d_loss_fake[0])
                ...
                Ev_Real_Bot = round(
                    sum(pred_Bots[1]) / test_x_Bots.shape[0], 4)  #
        ...
        Disc_G_Z_B_acc_ = pd.DataFrame(
            Disc_G_Z_B_acc_, columns=['GEN_Eva'])
        ...
        frames = [Disc_G_Z_Real_acc_,
                  Disc_G_Z_B_acc_, Disc_N_acc_, Disc_B_acc_, D_Loss_ZERO_Fake, D_Loss_ZERO_Real, D_Loss_ONE_Real, G_Loss]
